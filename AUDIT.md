...
- **STATUS (2026-06-22):** approved + IN PROGRESS on branch `security/api-key-migration-5-18`. Non-secret prep staged (fallback removal, `.env.example`, docs). Dashboard steps + verification pending. **Legacy NOT yet deactivated — exposed key still live until step (5).** Docs: [migrating-to-new-api-keys](https://supabase.com/docs/guides/getting-started/migrating-to-new-api-keys), [api-keys](https://supabase.com/docs/guides/getting-started/api-keys).
